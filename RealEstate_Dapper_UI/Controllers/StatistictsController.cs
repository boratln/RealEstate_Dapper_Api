...
{
    public class StatistictsController : Controller
    {
        private readonly IHttpClientFactory _httpClientFactory;
        private readonly ApiSettings _apisettings;
        public StatistictsController(IHttpClientFactory httpClientFactory,IOptions<ApiSettings> apisettings)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage6 = await client6.GetAsync("Statistics/AvereageRoomCount");
